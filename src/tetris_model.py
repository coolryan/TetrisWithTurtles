...
class Block:
    """docstring for Block"""
    # constructor
    def __init__(self, x: int = 0, y: int = 0, color: list[str] = "black", speed: int = 0):
        self.x, self.y = x, y
        self.color = color
        self.speed = speed
...
class Shape:
    ...
    def __init__(self, x: int, y: int, shapeType: type):
        # Block Shape
        self.listOfBlocks = []
        self.color = ["red", "blue", "purple", "lightblue", "yellow", "orange", "green", "pink", "grey"]
    ...
    def initiate_shape(self):
        ...
        if self.shapeType == ShapeType.I_TETROMINO and self.color == "lightblue" or self.color == "grey":
        ...
        elif self.shapeType == ShapeType.O_TETROMINO and self.color == "yellow":
            ...
            self.listOfBlocks.append(Block((self.x+BLOCK_HEIGHT*2), (self.y+BLOCK_HEIGHT*2), self.color, self.speed+10))
            self.listOfBlocks.append(Block((self.x+BLOCK_HEIGHT*3), (self.y+BLOCK_HEIGHT*3), self.color, self.speed+10))

        elif self.shapeType == ShapeType.T_TETROMINO and self.color == "purple" or self.color == "pink":
            self.listOfBlocks.append(Block(self.x, self.y, self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, self.y+BLOCK_HEIGHT, self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, (self.y+BLOCK_HEIGHT*2), self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, (self.y+BLOCK_HEIGHT*3), self.color, self.speed+5))
        ...
        elif self.shapeType == ShapeType.L_TETROMINO and self.color == "blue" or self.color == "orange":
            self.listOfBlocks.append(Block(self.x, self.y, self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, self.y+BLOCK_HEIGHT, self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, (self.y+BLOCK_HEIGHT*2), self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, (self.y+BLOCK_HEIGHT*3), self.color, self.speed+5))
        ...
        elif self.shapeType == ShapeType.J_TETROMINO and self.color == "blue":
            self.listOfBlocks.append(Block(self.x, self.y, self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, self.y+BLOCK_HEIGHT, self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, (self.y+BLOCK_HEIGHT*2), self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, (self.y+BLOCK_HEIGHT*3), self.color, self.speed+5))
        ...
        elif self.shapeType == ShapeType.S_TETROMINO and self.color == "green":
            self.listOfBlocks.append(Block(self.x, self.y, self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, self.y+BLOCK_HEIGHT, self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, (self.y+BLOCK_HEIGHT*2), self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, (self.y+BLOCK_HEIGHT*3), self.color, self.speed+5))
        ...
        elif self.shapeType == ShapeType.Z_TETROMINO and self.color == "red":
            self.listOfBlocks.append(Block(self.x, self.y, self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, self.y+BLOCK_HEIGHT, self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, (self.y+BLOCK_HEIGHT*2), self.color, self.speed+5))
            self.listOfBlocks.append(Block(self.x, (self.y+BLOCK_HEIGHT*3), self.color, self.speed+5))
